...
Calibrado com:
- bairronet_2381_pc_021786.pdf (BR PROVEDOR LTDA)
- telecab_287250_pc_.pdf (TELECAB TELECOMUNICACOES LTDA)
"""
import re
...
def parse(texto: str, caminho: Path) -> ParseResult:
    ...
    if valor_total_nf and (
        ...
        or "TELECAB TELECOMUNICACOES" in upper
        or "TELECAB TELECOMUNICAÇÕES" in upper
    ):
        itens = [ItemExtraido(
